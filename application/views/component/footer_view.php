<div class="bg-light postion-static bottom-0 border-top">
  ...
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-0" style="height: 100px;">
    <div class="col-md-4 d-flex align-items-center">
      ...
      <span class="mb-3 mb-md-0 text-muted">© 2022 TEAMP4T Shopping</span>
    </div>

    <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
      <li class="ms-3">
        <a class="text-muted" href="https://instagram.com/ivan_wayann">
      ...
      <li class="ms-3">
        <a class="text-muted" href="https://wa.me/6283142884161?text=Halo+kak+saya+ingin+bertanya+">
      ...
      <li class="ms-3">
        <a class="text-muted" href="https://fb.me/0000">
