<div class="container" style="min-height: 100vh;">
  <div class="d-flex align-items-center justify-content-center" style="min-height: 100vh;width: auto;">
    <div class="d-grid text-center justify-content-center">
      <h1 class="mb-4">Masuk Sebagai Admin</h1>
      <form class="login-user admin">
        <?php
        ...
        foreach ($input_fields as $key => $input_element) {
          ...
          echo '<div class="form-group mb-3 rounded-pill">' .
            '<div class="d-flex border rounded-pill mx-auto" style="background-color: white; width: 300px"><input name="' . $key . '" type="' . $input_element['type'] . '" class="form-control rounded-pill text-left shadow-none border-0 m-0" placeholder="' . $input_element['placeholder'] . '">' . $eye . '</div>' .
            '</div>';
        }
        ?>
        <div class="d-grid">
