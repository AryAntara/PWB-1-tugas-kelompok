...
<div id="carouselExampleCaptions" class="carousel slide position-fixed top-0" data-bs-ride="carousel" style="z-index: -1;width: 100%">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="<?= base_url() ?>assets/img/topi.png" class="d-block" alt="..." style="width: 100%; object-fit: cover; margin: 0">  
      <div class="carousel-caption d-none d-md-block">
      </div>
    </div>
    <div class="carousel-item">
      <img src="<?= base_url() ?>assets/img/jeans.png" class="d-block" alt="..." style="width: 100%; object-fit: cover; height: 100vh">
      <div class="carousel-caption d-none d-md-block">
      </div>
    </div>
  </div>
...
<div class="home-android pb-5 bg-abu-abu border-top" style="min-height: 100vh; width: 100%;height: auto">
  ...
  <!-- Recomend -->
    <div class="d-flex justify-content-between">
      ...
      <a class="btn mx-2 py-auto shadow-none" href="<?= base_url()?>product/all">Lihat Semua ></a>
    </div>
      ...
      <div class="card m-2 border border-2 shadow-sm" style="width: 14rem;height: 22rem">
        <div class="product" data-id="<?= $product->id_produk ?>" style="width: 100%;height:12rem"> <img src="<?= base_url().$product->gambar_produk ?>" class="card-img-top" alt="..." > </div>
          <div class="card-body bg-light">
            ...
            <button class="btn btn-outline-primary btn-sm mx-1 <?= $product->stok <= 0 ? 'disabled' : '' ?> add-cart" data-id='<?= $product->id_produk?>'>
      ...
      <?php foreach($product_popular as $product):?>
        <div class="card m-2 border border-2 shadow-sm" style="width: 14rem;height: 22rem">
          ...
          <div class="card-body bg-light">
            ...
            <p class="card-text text-success">Rp. <?= number_format($product->harga,0,',','.') ?></p>
            <div class="d-flex">        
              <button class="add-cart btn btn-outline-primary btn-sm mx-1 <?= $product->stok <= 0 ? 'disabled' : '' ?>" data-id='<?= $product->id_produk?>'>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16">
                  <path d="M9 5.5a.5.5 0 0 0-1 0V7H6.5a.5.5 0 0 0 0 1H8v1.5a.5.5 0 0 0 1 0V8h1.5a.5.5 0 0 0 0-1H9V5.5z"/>
                  <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1H.5zm3.915 10L3.102 4h10.796l-1.313 7h-8.17zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
                </svg>
