...
<div class="container mt-4 bg-light mb-4 ">
    <p class="w-100 fs-5 fw-bold pt-5 pb-4 text-center">Produk Favorit Kamu Suka</p>
    <div class="d-flex justify-content-center flex-wrap pb-4">
        <?php if(count($products) < 1){ ?> 
            <div class="d-flex justify-content-center align-items-center" style="height: 100vh">        
                <div class="d-flex flex-column justify-content-center bg-light align-items-center" style="width: 90%; height: 80%">
                    <img src="<?= base_url('assets/img/vector/nothing_here/index.jpg') ?>" alt="" width="300px">
                    <div class="text-center d-flex align-items-center card-body h-auto">
                        <h1 class="card-text w-50 mx-auto my-auto text-wrap">Waduh :( <br/>Produk Favorit mu masih kosong nih
                        <a class="text-danger text-decoration-none" href="<?= base_url('')?>">Yuk Sukai Produk</a><h1>
                    </div>
                </div>
            </div>
        <?php } ?>
